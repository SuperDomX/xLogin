      ...
      */
      private function login($username,$password){	
        ...
        if($this->is_email($username)){
          $u = $this->getUserByEmail($username,'id,username,email,password,hash,power_lvl,name,picture_src');				
        }else{
          $u = $this->getUserByName($username,'id,username,email,password,hash,power_lvl,name,picture_src');
        }
